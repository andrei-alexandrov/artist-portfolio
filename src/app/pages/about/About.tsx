  ...
  return (
    <div id="about" className="about-container">
      ...
      <div className="about-description">
        Искра Милкова е потопена в света на музиката от ранно детство. Завършва училище по изкуства специалност пиано, но скоро открива, че истинската ѝ страст е
        човешкият глас и неговата уникална способност да докосва сърцата на хората.<br /><br />
        ...
        и Modern Vocal Training (MVT) в Испания, където се задълбочава в метода Speech Level of Singing (SLS).<br /><br />
        Вдъхновена от новопридобитите знания и вокални подходи, Искра основава Вокална академия HighLight Singing Academy, където днес работи с прекрасния си екип от изключителни преподаватели
        ...
        Паралелно с ролята си на вокален педагог, Искра продължава да се изявява като активен изпълнител в различни групи и музикални проекти. През 2017 г. тя е вокален педагог на българската делегация за конкурса &quot;Евровизия&quot;.
        Един от най-значимите ѝ успехи като вокален треньор е победата на нейната ученичка Жаклин Таракчи в &quot;Гласът на България&quot; през 2022 г.<br />
